...
export const currentAppConfig: AppConfig = {
  ...
  modules: [
    ...
    { id: 'units', label: 'فهرست واحدها', routePrefix: '/units', requiredPermission: 'complex.view' },
    { id: 'contracts', label: 'قراردادها', routePrefix: '/contracts', requiredPermission: 'contracts.view' },
    { id: 'payments', label: 'واریزی مشتریان', routePrefix: '/payments', requiredPermission: 'contracts.view' },
