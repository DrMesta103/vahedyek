  ...
  return (
    <section className={`space-y-5 rounded-3xl border border-slate-200 bg-slate-50/70 ${compact ? 'p-4' : 'p-5'}`} dir="rtl">
      ...
      <div className="space-y-2">
        <label className="block text-right text-sm font-extrabold text-slate-700">حداکثر تعداد دفعات تاخیر در یک قرارداد</label>
        <Input
      ...
      <div className="space-y-2">
        <label className="block text-right text-sm font-extrabold text-slate-700">مهلت تنفس (بدون لغو تخفیف)*</label>
        <Input
      ...
      <div className="space-y-3">
        <label className="block text-right text-sm font-extrabold text-slate-700">سررسید ها متاثر از شرط تخفیف</label>
        <MultiTagPills
      ...
      <div className="space-y-3">
        <label className="block text-right text-sm font-extrabold text-slate-700">زمان تسویه تخفیف</label>
        <TagPills
