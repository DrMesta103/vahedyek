  ...
  return (
    <div className="space-y-4" dir="rtl">
        ...
        {!loading ? (
          <div className="mt-4 space-y-3">
            {visibleGroups.map((group) => (
              <article key={group.id} className="rounded-[8px] border border-slate-300/80 bg-white p-5 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
      ...
      {dialog ? (
        ...
        >
          <div
            className="w-full max-w-[720px] overflow-hidden rounded-[8px] border border-slate-200 bg-white shadow-[0_28px_90px_rgba(15,23,42,0.32)]"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <div className="grid gap-5 px-8 pb-8 pt-6">
              ...
              <div className="grid gap-3 text-right">
                ...
                <div className="rounded-[8px] border border-slate-200 bg-slate-50/80 p-3">
                      ...
                      projectSpecs.map((spec) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex w-full items-center gap-3 rounded-[8px] border px-4 py-3 text-right transition ${
                              active
                          ...
                          >
                            <span
                              className={`inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-[8px] border-2 ${
