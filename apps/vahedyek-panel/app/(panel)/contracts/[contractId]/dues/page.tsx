      ...
      <main className="contract-details-page w-full max-w-none min-w-0" dir="rtl" lang="fa">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            <section className="rounded-[8px] border border-slate-200/80 bg-white/90 px-5 py-4 text-right shadow-sm md:px-6 md:py-5">
            ...
            <section className="rounded-[8px] border border-slate-200/80 bg-white/90 p-5 text-right shadow-sm md:p-7">
              ...
              >
                <div
                  tabIndex={0}
                  className="rounded-[8px] border border-slate-200/90 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--dark-teal)_06%,white),white)] px-4 py-3.5 shadow-[0_1px_0_rgba(15,23,42,0.04)] outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--dark-teal)_40%,transparent)] focus-visible:ring-offset-2"
                ...
                <div
                  tabIndex={0}
                  className="rounded-[8px] border border-slate-200/90 bg-white px-4 py-3.5 shadow-[0_1px_0_rgba(15,23,42,0.04)] outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_srgb,var(--dark-teal)_40%,transparent)] focus-visible:ring-offset-2"
                ...
                <div
                  tabIndex={0}
                  className="rounded-[8px] border border-rose-200/80 bg-rose-50/70 px-4 py-3.5 shadow-[0_1px_0_rgba(15,23,42,0.04)] outline-none focus-visible:ring-2 focus-visible:ring-rose-300/70 focus-visible:ring-offset-2"
                  title={TT_TOTAL_DEBT}
                >
                  <div
...
function ReceiptSummaryCard({ label, value, tone }: { label: string; value: string; tone?: 'teal' }) {
  return (
    <div className={`rounded-[8px] border px-4 py-3.5 shadow-sm ${tone === 'teal' ? 'border-[color-mix(in_srgb,var(--dark-teal)_22%,#cbd5e1)] bg-[color-mix(in_srgb,var(--dark-teal)_06%,white)]' : 'border-slate-200 bg-white'}`}>
