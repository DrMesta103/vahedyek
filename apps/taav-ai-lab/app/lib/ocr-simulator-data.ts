...
export const OCR_SAMPLE_LIBRARY: OcrSampleDocument[] = [
  {
    ...
    confidence: 98,
    pageCount: 2,
    summary: 'فاکتور فروش با دقت بالا به ساختار قالب و نتیجه تبدیل می‌شود.',
    ...
    scenarios: {
      recognize: {
        ...
        warnings: ['فیلد وضعیت پرداخت برای بازبینی دستی علامت‌گذاری شد.'],
      },
    },
  },
  {
    ...
    lane: 'quick',
    title: 'کارت ملی',
    description: 'قالب هویتی برای شبیه‌سازی نویسه‌خوانی کارت ملی با دو سناریوی تشخیص و عدم تشخیص.',
    ...
    scenarios: {
      recognize: {
        ...
        confidence: 92,
        tokensUsed: 2800,
        summary: 'کارت ملی با سطح اطمینان مناسب تشخیص داده شد و برخی فیلدها برای بازبینی سبک علامت‌گذاری شدند.',
        previewLines: ['نام و نام خانوادگی', 'شماره ملی', 'تاریخ تولد', 'محل صدور'],
        result: {
          overall_status: 'completed_with_review_required',
          fields: [
        ...
        warnings: ['محل صدور با سطح اطمینان پایین‌تر برای بازبینی دستی نگه داشته شد.'],
      },
      miss: {
        label: 'تشخیص ندهد',
        confidence: 18,
        ...
        warnings: [
          'هوش مصنوعی کارت ملی را با اطمینان کافی تشخیص نداد.',
  ...
  },
  {
    ...
    lane: 'quick',
    title: 'رسید پرداخت',
    description: 'قالب کوتاه برای تست سرعت نویسه‌خوانی و استخراج اطلاعات تراکنش.',
    ...
    scenarios: {
      recognize: {
        ...
        warnings: ['فیلد زمان تراکنش برای بازبینی سبک نگه داشته شد.'],
      },
    },
  },
  {
    ...
    expectedResult: {
      ...
      fields: [
        ...
        resultField('subject', 'آزمایش نویسه‌خوانی', 'آزمایش نویسه‌خوانی', 0.94, 'valid', 'accepted'),
        resultField('start_date', '1405/04/08', '1405/04/08', 0.88, 'valid', 'needs_review', ['date_inferred']),
      ],
    },
    sampleText: 'قرارداد واحد\nطرف اول: آزمایشگاه هوش مصنوعی تاو\nطرف دوم: سازمان همکار\nمدت: ۱۲ ماه\nموضوع: آزمایش نویسه‌خوانی',
    scenarios: {
      recognize: {
        label: 'تشخیص استاندارد',
        confidence: 95,
        tokensUsed: 5100,
        summary: 'بندهای اصلی قرارداد با سطح اطمینان بالا استخراج شدند و یک فیلد برای بازبینی دستی باقی ماند.',
        previewLines: ['قرارداد واحد', 'طرف اول: تاو', 'طرف دوم: شریک تجاری', 'مدت: ۱۲ ماه'],
        result: {
          overall_status: 'completed_with_review_required',
          fields: [
