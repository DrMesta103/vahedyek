...
export const CREATE_BUILD_AND_OUTBOX_CARDS: BuildVersionStepDocCard[] = [
  ...
  {
    id: 'concurrent-publish',
    order: 7,
    title: 'جلوگیری از Publish هم‌زمان',
    tag: 'بک',
    kind: 'lock',
    lockKey: 'UPDLOCK + READPAST',
    mechanism: 'Outbox Claim / Lease',
    note: 'هر پیام فقط توسط یک Worker در هر لحظه Claim می‌شود؛ مصرف‌کننده همچنان باید Idempotent باشد.',
  },
  {
    id: 'output',
    order: 8,
