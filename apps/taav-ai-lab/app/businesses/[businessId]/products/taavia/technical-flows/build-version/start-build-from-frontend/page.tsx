...
export default async function StartBuildFromFrontendPage({
  params,
}: {
  ...
  const currentHref = `${overviewHref}/${START_BUILD_FRONTEND_META.slug}`;
    ...
    >
      <div className="ai-lab-page-stack">
        <TaavPageHeader
          ...
          eyebrow="محصول تاویا"
          title={START_BUILD_FRONTEND_META.title}
          description={START_BUILD_FRONTEND_META.description}
          status="active"
          meta={
            <div className="flex flex-wrap items-center gap-2">
              {START_BUILD_FRONTEND_META.pills.map((pill) => (
                <span
                  key={pill}
