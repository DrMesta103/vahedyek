...
import {
  RECEIVE_EVENT_AND_CREATE_INBOX_JOB_CARDS,
  RECEIVE_EVENT_AND_CREATE_INBOX_JOB_META,
  RECEIVE_EVENT_AND_CREATE_INBOX_JOB_OVERVIEW_NOTE,
  RECEIVE_EVENT_AND_CREATE_INBOX_JOB_OVERVIEW_STEPS,
} from '@/app/lib/taavia-build-version-receive-event-and-create-inbox-job';
...
export default async function ReceiveEventAndCreateInboxJobPage({
  params,
}: {
  ...
  const currentHref = `${overviewHref}/${RECEIVE_EVENT_AND_CREATE_INBOX_JOB_META.slug}`;
    ...
    >
      <div className="ai-lab-page-stack">
        <TaavPageHeader
          ...
          eyebrow="محصول تاویا"
          title={RECEIVE_EVENT_AND_CREATE_INBOX_JOB_META.title}
          description={RECEIVE_EVENT_AND_CREATE_INBOX_JOB_META.description}
          status="active"
          meta={
            <div className="flex flex-wrap items-center gap-2">
              {RECEIVE_EVENT_AND_CREATE_INBOX_JOB_META.pills.map((pill) => (
                <span
                  key={pill}
        ...
        <BuildVersionStepDocClient
          cards={RECEIVE_EVENT_AND_CREATE_INBOX_JOB_CARDS}
          overviewSteps={RECEIVE_EVENT_AND_CREATE_INBOX_JOB_OVERVIEW_STEPS}
          overviewNote={RECEIVE_EVENT_AND_CREATE_INBOX_JOB_OVERVIEW_NOTE}
        />
      </div>
    </AiLabShell>
  );
