...
import {
  SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_CARDS,
  SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_META,
  SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_OVERVIEW_NOTE,
  SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_OVERVIEW_STEPS,
} from '@/app/lib/taavia-build-version-send-status-to-flutter-with-signalr';
...
export default async function SendStatusToFlutterWithSignalrPage({
  params,
}: {
  ...
  const currentHref = `${overviewHref}/${SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_META.slug}`;
    ...
    >
      <div className="ai-lab-page-stack">
        <TaavPageHeader
          ...
          eyebrow="محصول تاویا"
          title={SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_META.title}
          description={SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_META.description}
          status="active"
          meta={
            <div className="flex flex-wrap items-center gap-2">
              {SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_META.pills.map((pill) => (
                <span
                  key={pill}
        ...
        <BuildVersionStepDocClient
          cards={SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_CARDS}
          overviewSteps={SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_OVERVIEW_STEPS}
          overviewNote={SEND_STATUS_TO_FLUTTER_WITH_SIGNALR_OVERVIEW_NOTE}
        />
      </div>
    </AiLabShell>
  );
