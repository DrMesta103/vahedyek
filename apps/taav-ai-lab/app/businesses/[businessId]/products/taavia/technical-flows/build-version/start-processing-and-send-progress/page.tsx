...
import {
  START_PROCESSING_AND_SEND_PROGRESS_CARDS,
  START_PROCESSING_AND_SEND_PROGRESS_META,
  START_PROCESSING_AND_SEND_PROGRESS_OVERVIEW_NOTE,
  START_PROCESSING_AND_SEND_PROGRESS_OVERVIEW_STEPS,
} from '@/app/lib/taavia-build-version-start-processing-and-send-progress';
...
export default async function StartProcessingAndSendProgressPage({
  params,
}: {
  ...
  const currentHref = `${overviewHref}/${START_PROCESSING_AND_SEND_PROGRESS_META.slug}`;
    ...
    >
      <div className="ai-lab-page-stack">
        <TaavPageHeader
          ...
          eyebrow="محصول تاویا"
          title={START_PROCESSING_AND_SEND_PROGRESS_META.title}
          description={START_PROCESSING_AND_SEND_PROGRESS_META.description}
          status="active"
          meta={
            <div className="flex flex-wrap items-center gap-2">
              {START_PROCESSING_AND_SEND_PROGRESS_META.pills.map((pill) => (
                <span
                  key={pill}
        ...
        <BuildVersionStepDocClient
          cards={START_PROCESSING_AND_SEND_PROGRESS_CARDS}
          overviewSteps={START_PROCESSING_AND_SEND_PROGRESS_OVERVIEW_STEPS}
          overviewNote={START_PROCESSING_AND_SEND_PROGRESS_OVERVIEW_NOTE}
        />
      </div>
    </AiLabShell>
  );
