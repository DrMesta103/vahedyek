...
import { advanceInitialKnowledgeBuild, cancelInitialKnowledgeBuild, completeInitialKnowledgeBuild, failInitialKnowledgeBuild, resetInitialKnowledgeBuild, retryInitialKnowledgeBuild, startInitialKnowledgeBuild } from "@/app/lib/taavia-initial-kb-build";
...
function refresh(businessId: string, brandId: string) { const base = `/businesses/${businessId}/products/taavia/brands/${brandId}`; revalidatePath(base); revalidatePath(`${base}/knowledge-base`); }
