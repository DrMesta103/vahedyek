...
export function TestKnowledgeBaseCategoriesPreview({
  ...
  return (
    <>
      <aside className="sticky top-2 hidden max-h-[calc(100vh-8rem)] w-full overflow-y-auto rounded-[14px] bg-[linear-gradient(180deg,rgba(18,30,56,0.94)_0%,rgba(10,19,38,0.94)_100%)] p-2.5 lg:block">
        {panelBody}
      </aside>
