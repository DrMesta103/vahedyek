...
export const SETUP_MODULE_CARDS: ModuleCardDemoItem[] = [
  {
    ...
    description:
      'در این بخش می‌توانید تمامی اطلاعات پروفایل کسب‌وکار را وارد کنید؛ مانند اطلاعات نماینده قانونی، شماره‌حساب‌ها، زبان‌های فعال و غیره.',
  },
  {
  ...
  },
  {
    ...
    description:
      'در این بخش اطلاعات بلوک یا برج به همراه طبقات، واحدها و انواع کاربری‌های مختلف هر واحد را ثبت می‌کنید.',
  },
  {
    id: 'financial-settings',
    title: 'تنظیمات مالی و قواعد قراردادی',
    description:
      'در این بخش می‌توانید چارچوب‌های مالی و مفاد قراردادی پروژه را تعریف کنید تا هنگام تنظیم قرارداد، به‌صورت پیشنهادی مورد استفاده قرار گیرند.',
  },
  {
    id: 'approval-process',
    title: 'فرآیند تایید',
...
export const OWNERSHIP_MODULE_CARDS: ModuleCardDemoItem[] = [
  ...
  },
  {
    ...
    description: '( تکمیل نشده ) مدیریت و تنظیم قراردادها، فرم‌های رسمی و الحاقیه‌ها',
    status: 'incomplete',
  },
  {
    id: 'main-partners',
    title: 'شرکای اصلی',
    description: '( تکمیل نشده ) مدیریت شرکای اصلی و اطلاعات مرتبط با کسب‌وکارهای حقیقی',
    status: 'incomplete',
  },
  {
    id: 'account-number',
