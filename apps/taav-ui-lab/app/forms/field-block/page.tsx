...
export default function FieldBlockDocPage() {
  ...
  return (
    ...
    >
      <DocPageHeader
        eyebrow="Business Form Pattern"
        title="TaavFieldBlock"
        description="الگوی فیلد کسب‌وکاری با label بالای کنترل، متن راهنمای ثابت زیر فیلد، و اولویت بصری روشن برای خطا و وضعیت."
