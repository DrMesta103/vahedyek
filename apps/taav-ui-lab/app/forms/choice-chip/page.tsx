...
export default function ChoiceChipDocPage() {
  return (
    <DocPageShell breadcrumbs={[{ label: 'خانه', href: '/' }, { label: 'Forms', href: '/forms' }, { label: 'Choice Chip' }]}>
      <DocPageHeader
        eyebrow="Form Selection"
        title="TaavChoiceChipGroup"
        description="تنها کامپوننت انتخاب چیپی TaavUI برای فرم‌های کسب‌وکار. عنوان و توضیحات اختیاری، سایز و tone قابل تنظیم، بدون border کلی."
