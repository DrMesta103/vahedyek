...
export default function PercentageInputDocPage() {
  ...
  return (
    ...
    >
      <DocPageHeader
        ...
        description="این کامپوننت برای ورود درصد استفاده می‌شود. علامت درصد داخل فیلد در سمت چپ نمایش داده می‌شود و مقدار باید در بازه مجاز تعیین‌شده باقی بماند."
      ...
      <DocSection title="Do / Don't">
        <DocDoDont
          doItems={['برای درصدهای قرارداد از min/max صریح استفاده کنید']}
          dontItems={['علامت % را به صورت دستی به TaavInput اضافه نکنید']}
        />
      </DocSection>
    </DocPageShell>
  );
