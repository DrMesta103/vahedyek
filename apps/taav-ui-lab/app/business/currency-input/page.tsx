...
export default function BusinessCurrencyInputDocPage() {
  ...
  return (
    ...
    >
      <DocPageHeader
        ...
        description="ورودی مبلغ تخصصی فرم‌های کسب‌وکار — عدد سه‌رقمی جدا می‌شود و واحد پول (ریال/تومان) داخل فیلد نمایش داده می‌شود. برای قرارداد، حقوق، وام و تنظیمات مالی."
        importCode={`import { TaavCurrencyInput } from "@repo/ui/taav/forms";`}
      />
      <DocApiNote />

      <DocSection title="نمای مرجع (RTL)">
        <DocPreview label="Screenshot-like demo — قرارداد و حقوق">
      ...
      <DocSection title="Do / Don't">
        <DocDoDont
          doItems={[
            'با TaavFieldBlock برای label و tooltip در فرم‌های کسب‌وکار استفاده کنید',
            'onValueChange عدد خام بدون جداکننده برمی‌گرداند',
            'currency را صریح (rial / toman) مشخص کنید',
          ]}
          dontItems={[
