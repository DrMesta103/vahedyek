  ...
  return {
    ...
    data: {
      ...
      benefits: {
        ...
        seniorityAllowance: { enabled: true, amount: baseSettings.benefits.seniorityAllowance, calculationRules: { ...(baseSettings.benefitRules?.seniorityAllowance ?? DEFAULT_SENIORITY_BENEFIT_RULES) } },
...
export function normalizeContractDraftTemplate(value: unknown): ContractDraftTemplate | null {
  ...
  const normalizedBenefits = {
    ...
    seniorityAllowance: normalizeBenefit(rawBenefits?.seniorityAllowance, DEFAULT_SENIORITY_BENEFIT_RULES),
