...
export default function DevDocEventsPageClient() {
  ...
  if (process.env.NODE_ENV !== 'development') {
    return (
      <section className="mx-auto max-w-5xl p-4">
        <div className="rounded-[24px] border border-[color:var(--border-color)] bg-[color:var(--surface)] p-4 text-center text-sm text-[color:var(--text-muted)]">
  ...
  return (
    <section className="mx-auto max-w-6xl p-4 sm:p-4">
      <div className="mb-5 rounded-[24px] border border-[color:var(--border-color)] bg-[color:var(--surface)] p-5">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <div className="rounded-xl bg-[color:var(--surface-soft)] px-4 py-3 text-sm text-[color:var(--text-body)]">ایجاد: {groupedCount.create}</div>
          <div className="rounded-xl bg-[color:var(--surface-soft)] px-4 py-3 text-sm text-[color:var(--text-body)]">ویرایش: {groupedCount.update}</div>
          <div className="rounded-xl bg-[color:var(--surface-soft)] px-4 py-3 text-sm text-[color:var(--text-body)]">حذف: {groupedCount.delete}</div>
          <div className="rounded-xl bg-[color:var(--surface-soft)] px-4 py-3 text-sm text-[color:var(--text-body)]">نتیجه فیلتر: {filteredEvents.length}</div>
        </div>
      </div>
      ...
      <div className="mb-5 grid gap-3 rounded-[24px] border border-[color:var(--border-color)] bg-[color:var(--surface)] p-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <label className="grid gap-2">
          ...
          <select
            ...
            className="h-9 rounded-lg border border-[color:var(--border-color)] bg-[color:var(--surface)] px-3 text-[13px] text-[color:var(--text-body)] outline-none"
          >
