    ...
    <FormBox title="دسته‌بندی‌های مالی" description="برای هر دسته‌بندی می‌توانید سقف مبلغ و سررسیدها را مدیریت کنید.">
      <div className="mb-4 space-y-3">
                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="relative flex items-center gap-1">
                    ...
                    {openInfoId === category.id ? (
                      <div className="absolute left-0 top-8 z-20 w-72 rounded-xl border border-sky-100 bg-white p-3 shadow-lg" onClick={(event) => event.stopPropagation()}>
                    ...
                    {openMenuId === category.id ? (
                      <div className="absolute left-0 top-8 z-20 min-w-[132px] rounded-xl border border-gray-200 bg-white p-1.5 shadow-lg" onClick={(event) => event.stopPropagation()}>
                        <button
                          type="button"
        ...
        <div className="flex justify-end">
          <button type="button" onClick={onOpenAddCategory} className="inline-flex h-10 items-center gap-2 rounded-lg border border-teal-300 bg-teal-50 px-4 text-sm font-medium text-teal-700 hover:bg-teal-100">
      ...
      <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
        <div className="mb-4 flex flex-col gap-3 border-b border-gray-200 pb-4 md:flex-row md:items-center md:justify-between">
          ...
          <button type="button" onClick={onOpenDueDialog} className="inline-flex h-9 items-center gap-2 rounded-lg border border-teal-300 bg-teal-50 px-4 text-sm font-medium text-teal-700 hover:bg-teal-100">
            <Plus className="h-4 w-4" />
            ثبت سررسید
          </button>
        </div>
