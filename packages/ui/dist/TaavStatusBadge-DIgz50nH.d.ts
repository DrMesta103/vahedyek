...
import { c as TaavBadgeVariant } from './taav-badge.variants-DM1buIc6.js';
...
declare function TaavStatusBadge({ status, size, variant, withDot, icon, label, children, wrapperClassName, }: TaavStatusBadgeProps): react.JSX.Element;
