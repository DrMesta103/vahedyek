...
import { a as TaavLayoutPadding, T as TaavLayoutDensity } from './layout.variants-CvMtAmDy.mjs';
import { T as TaavStatus } from './TaavStatusBadge-Bkr6L0VQ.mjs';
import 'clsx';
...
declare function TaavSection({ title, description, eyebrow, icon, badge, actions, footer, children, variant, padding, density, collapsible, defaultCollapsed, disabled, loading, headerClassName, contentClassName, wrapperClassName, ...props }: TaavSectionProps): react_jsx_runtime.JSX.Element;
...
declare function TaavSidebarPanel({ title, description, icon, status, actions, footer, children, variant, width, sticky, collapsible, defaultCollapsed, density, loading, headerClassName, contentClassName, wrapperClassName, ...props }: TaavSidebarPanelProps): react_jsx_runtime.JSX.Element;
