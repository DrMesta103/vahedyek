...
function TaavSidebarPanel({
  ...
  const isCollapsed = collapsible && collapsed;
  if (loading) {
    return /* @__PURE__ */ jsxRuntime.jsxs("aside", { className: cn(variantClass[variant], widthClass[width], layoutPaddingClass.md, wrapperClassName), children: [
      /* @__PURE__ */ jsxRuntime.jsx(TaavSkeleton, { variant: "title" }),
...
exports.cn = cn;
//# sourceMappingURL=taav-layout-interactive.js.map
//# sourceMappingURL=taav-layout-interactive.js.map