...
function TaavSidebarPanel({
  ...
  const isCollapsed = collapsible && collapsed;
  if (loading) {
    return /* @__PURE__ */ jsxs("aside", { className: cn(variantClass[variant], widthClass[width], layoutPaddingClass.md, wrapperClassName), children: [
      /* @__PURE__ */ jsx(TaavSkeleton, { variant: "title" }),
...
export { TAAV_BUTTON_HEIGHT, TAAV_DURATION, TAAV_RADIUS, TAAV_SHADOW, TAAV_SPACING, TAAV_TOKEN_CATALOG, TAAV_TOKEN_SECTIONS, TAAV_TONE_LABELS, TaavSection, TaavSidebarPanel, cn };
//# sourceMappingURL=taav-layout-interactive.mjs.map
//# sourceMappingURL=taav-layout-interactive.mjs.map