...
type TokenCategory = 'color' | 'semantic' | 'typography' | 'spacing' | 'radius' | 'shadow' | 'focus' | 'motion' | 'component' | 'business-sidebar' | 'module-card' | 'business-intro-card' | 'activation-switch' | 'details-link' | 'recommendation-card';
type TokenEntry = {
    name: string;
    cssVar: string;
    value: string;
